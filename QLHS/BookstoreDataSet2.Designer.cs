...
namespace QLHS {
    ...
    public partial class BookstoreDataSet2 : global::System.Data.DataSet {
        ...
        public partial class NhanVienDataTable : global::System.Data.TypedTableBase<NhanVienRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public NhanVienRow AddNhanVienRow(string maNV, string tenNV, string viTri, string sdt, string gioiTinh, string email, string matkhau, System.DateTime ngaysinh) {
...
namespace QLHS.BookstoreDataSet2TableAdapters {
    ...
    public partial class NhanVienTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[NhanVien] WHERE (([maNV] = @Original_maNV) AND ((@IsNull_tenNV = 1 AND [tenNV] IS NULL) OR ([tenNV] = @Original_tenNV)) AND ((@IsNull_viTri = 1 AND [viTri] IS NULL) OR ([viTri] = @Original_viTri)) AND ((@IsNull_sdt = 1 AND [sdt] IS NULL) OR ([sdt] = @Original_sdt)) AND ((@IsNull_gioiTinh = 1 AND [gioiTinh] IS NULL) OR ([gioiTinh] = @Original_gioiTinh)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_matkhau = 1 AND [matkhau] IS NULL) OR ([matkhau] = @Original_matkhau)) AND ((@IsNull_ngaysinh = 1 AND [ngaysinh] IS NULL) OR ([ngaysinh] = @Original_ngaysinh)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[NhanVien] ([maNV], [tenNV], [viTri], [sdt], [gioiTinh], [email], [matkhau], [ngaysinh]) VALUES (@maNV, @tenNV, @viTri, @sdt, @gioiTinh, @email, @matkhau, @ngaysinh);
SELECT maNV, tenNV, viTri, sdt, gioiTinh, email, matkhau, ngaysinh FROM NhanVien WHERE (maNV = @maNV)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[NhanVien] SET [maNV] = @maNV, [tenNV] = @tenNV, [viTri] = @viTri, [sdt] = @sdt, [gioiTinh] = @gioiTinh, [email] = @email, [matkhau] = @matkhau, [ngaysinh] = @ngaysinh WHERE (([maNV] = @Original_maNV) AND ((@IsNull_tenNV = 1 AND [tenNV] IS NULL) OR ([tenNV] = @Original_tenNV)) AND ((@IsNull_viTri = 1 AND [viTri] IS NULL) OR ([viTri] = @Original_viTri)) AND ((@IsNull_sdt = 1 AND [sdt] IS NULL) OR ([sdt] = @Original_sdt)) AND ((@IsNull_gioiTinh = 1 AND [gioiTinh] IS NULL) OR ([gioiTinh] = @Original_gioiTinh)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_matkhau = 1 AND [matkhau] IS NULL) OR ([matkhau] = @Original_matkhau)) AND ((@IsNull_ngaysinh = 1 AND [ngaysinh] IS NULL) OR ([ngaysinh] = @Original_ngaysinh)));
SELECT maNV, tenNV, viTri, sdt, gioiTinh, email, matkhau, ngaysinh FROM NhanVien WHERE (maNV = @maNV)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT maNV, tenNV, viTri, sdt, gioiTinh, email, matkhau, ngaysinh FROM dbo.NhanV" +
                "ien";
        ...
        public virtual int Fill(BookstoreDataSet2.NhanVienDataTable dataTable) {
        ...
        public virtual BookstoreDataSet2.NhanVienDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            BookstoreDataSet2.NhanVienDataTable dataTable = new BookstoreDataSet2.NhanVienDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(BookstoreDataSet2.NhanVienDataTable dataTable) {
        ...
        public virtual int Delete(string Original_maNV, string Original_tenNV, string Original_viTri, string Original_sdt, string Original_gioiTinh, string Original_email, string Original_matkhau, global::System.Nullable<global::System.DateTime> Original_ngaysinh) {
        ...
        public virtual int Insert(string maNV, string tenNV, string viTri, string sdt, string gioiTinh, string email, string matkhau, global::System.Nullable<global::System.DateTime> ngaysinh) {
            if ((maNV == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string tenNV, string viTri, string sdt, string gioiTinh, string email, string matkhau, global::System.Nullable<global::System.DateTime> ngaysinh, string Original_maNV, string Original_tenNV, string Original_viTri, string Original_sdt, string Original_gioiTinh, string Original_email, string Original_matkhau, global::System.Nullable<global::System.DateTime> Original_ngaysinh) {
            return this.Update(Original_maNV, tenNV, viTri, sdt, gioiTinh, email, matkhau, ngaysinh, Original_maNV, Original_tenNV, Original_viTri, Original_sdt, Original_gioiTinh, Original_email, Original_matkhau, Original_ngaysinh);
        }
    }
